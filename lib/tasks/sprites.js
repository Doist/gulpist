...
gulp.task('sprite', function() {
    ...
    for (var config of configs) {
        ...
        if (config.cssHandlebarsHelpers) {
            var helpersContent = eval('(' + fs.readFileSync(config.cssHandlebarsHelpers).toString() + ')');

            spriteConfigs.cssHandlebarsHelpers = helpersContent;
        }
